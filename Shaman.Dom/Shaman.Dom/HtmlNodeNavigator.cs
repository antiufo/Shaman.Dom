...
namespace Shaman.Dom
{
    ...
    public class HtmlNodeNavigator : XPathNavigator
    {
        ...
        public HtmlNodeNavigator(HtmlNode context)
        {
            if (context == null)
            {
        ...
        {
            get { return _currentnode.OwnerDocument; }
        }
        ...
        {
            InternalTrace("id=" + id);
            HtmlNode node = /*CurrentDocument.DocumentNode.*/CurrentNode.DescendantsAndSelf().FirstOrDefault(x => x.Id == id);
            if (node == null)
            {
                InternalTrace(">false");
                return false;
        ...
        public override bool MoveToNext()
        {
            ...
            InternalTrace("_c=" + _currentnode);
            InternalTrace("_n=" + _currentnode.NextSibling);
        ...
        {
            _currentnode = _currentnode.OwnerDocument.DocumentNode;
            InternalTrace(null);
        }
        ...
        internal void InternalTrace(object traceValue)
        {
            ...
            string nodename = _currentnode == null ? "(null)" : _currentnode.TagName;
            string nodevalue;
            ...
            else
            {
                switch (_currentnode.NodeType)
                {
                    ...
                    default:
                        nodevalue = _currentnode.ToString();
                        break;
                }
            }
